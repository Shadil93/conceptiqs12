        ...
        <div class="contact-form col-lg-7">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 mt-4">
                    ...
                    <?php endif; ?>
 <div class="col-lg-12 mt-4">
                        <div class="g-recaptcha" data-sitekey="6LcT2g4rAAAAAAZKhGUnElT-Np6J7xArz8yalY3j"></div>
                        </div>
                        <div class="col-lg-12">
                        <button type="submit" class="butn bg-dark1 fsz-16 text-white py-3 mt-50 hover-bg-orange1"      class="g-recaptcha btn btn-primary"
...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- <div class="col-lg-12">
                    <button type="submit" class="butn bg-dark1 fsz-16 text-white py-3 mt-50 hover-bg-orange1">
                        <span> Submit Now <img class="ms-2 icon-6 w-auto" src="assets/img/arrow_wh.svg" alt=""> </span>
                    </button>
                </div> -->
            </div>
