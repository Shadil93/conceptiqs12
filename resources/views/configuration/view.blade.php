         ...
         <button  class="btn btn-success ml-3" ><a href="/register" style="color:#fff">Add</a><br></button>
          ...
          <!-- <span class=""><a href="/view">view</a></span>  -->
           ...
           <table class="table ">
            ...
            <tr>
            <td><span class="num">{{ ($data->currentPage() - 1) * $data->perPage() + $loop->iteration }}</span></td>
                <td>{{$datas->description}}</td>
                <td>{{$datas->subscription}}</td>
                <td>
                 @php
                ...
                @if(file_exists($uploadPath))
                    <img src="{{ asset('uploads/' . $datas->image) }}" width="100px" height="100px">
                @elseif(file_exists($storagePath))
                    <img src="{{ asset('storage/images/' . $datas->image) }}" width="100px" height="100px">
                @else
                ...
                <!-- <img src="{{ asset('uploads/' . $datas->image) }}" width="100px" height="100px"> -->
                 ...
                 <!-- <td><img src="{{asset('storage/images/' .$datas->images)}}"  width="100px" height="100px"></td> -->
                 <!-- <td><img src="{{ asset($datas->image) }}"  width="100px" height="100px"></td> -->
                <!-- <td><a href="{{route('configuration.edit',$datas->id)}}" class="btn btn-success">edit</a></td> -->
                <td class="text-center">
                    <a href="{{ route('configuration.edit', $datas->id) }}" class="btn btn-sm btn-light" title="Edit">
