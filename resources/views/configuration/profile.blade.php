...
<input type="file" id="image"  name="image" accept="image/*" hidden="" class="form-control"> 
 <img class="img-circle prof image1" src="@if(Auth::user()->image) {{asset('admin/profilepic/'.Auth::user()->image)}} @else {{asset('admin/images/no-image.png')}} @endif" alt="User Image"  width="100" height="100" id="show">  
     </div>
...
<div class="tab-pane" id="settings">
                 <form class="form-horizontal changePasswordAdminForm" action="{{url('adminChangePassword')}}" method="POST" >
                    {{ csrf_field() }}
